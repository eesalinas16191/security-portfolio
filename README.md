...
What I envisioned when I first went into this investigation was negative intentions from bad actors. However, after the investigation my perspective switched from bad intentions to finding out the source of the issue acted with a naive view of what was entrusted to them. I was perplexed that even someone acting in a misinformed manner was able to sneak by their deployment even when the policy assignments were thought to be configured correctly. It made me wonder and imagine how someone with true manipulative intentions could act if they encountered such an error in safety practices. The most difficult part of this investigation was finding the details of who which deployment created this and why it was even allowed since my assumption was that all of the deployments followed the proper policy assignments. 
...
## What I learned
I was left with a greater understanding of just how crucial naming the appropriate resource groups is. I was also surprised to learn how easily one could cause such an issue if when give just temporary access. This has also made me appreciate how important it is to follow certain practices and carefully monitor the actions displayed on the interface. I'd also investigate the issue through a different route of looking for unusual signs among the resource groups other than just looking at the names first, if given a chance to re-do the investigation. 
